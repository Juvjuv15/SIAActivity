    ...
    <!-- Card Body -->
            <div class="card-body">
                ...
                <table  width="100%">
                    ...
                    <tr>
                        <td>
                            <a href="{{url('/document/'.$sellers->tid.'/view')}}">VIEW ATTACHED DOCUMENTS</a></a>&emsp;||&emsp;<a href="{{url('/contract/'.$sellers->tid.'/view')}}">VIEW CONTRACT</a>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <font color="red" size="1"><b>{{ __('Seller') }}</b></font> <font color="" size="1">{{$sellers->owner}}</font>&emsp;
                            <font color="red" size="1"><b>{{ __('Date Bought') }}</b></font> <font color="" size="1">{{$sellers->datesold}}</font>
                        </td>
                    </tr>
                </table>
            </div>
