            ...
            <div class="card border-info rounded-5">
                <div class="card-header p-0">
                    <div class="bg-info text-white text-center py-2">
                        ...
                        <h1 style="margin: 20px 0px 20px 0px;">SELL/CHARTER PROPERTY</h1>
                        
                    </div>
                </div>
                <div class="card-body p-3">
                    <form autocomplete="off" action="{{url('seller/addlot')}}" method="post" enctype="multipart/form-data" id="form2">
                        @csrf
                        <center>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <span id="slotNumber" type="text" class="form-control" name="slotNumber">{{$lotDetails->lotNumber}}</span>
                            ...
                            <div class="col-md-6">
                                <span id="lotaddress" type="text" class="form-control" name="lotaddress">{{$lotDetails->lotAddress}}</span>
                            ...
                            <div class="col-md-6">
                            <span id="lottype" type="text" class="form-control" name="lottype">{{$lotDetails->lotType}}</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <span id="lotarea" type="text" class="form-control" name="lotarea">{{$lotDetails->lotArea}} {{$lotDetails->unitOfMeasure}}</span>
                                <!-- <input id="lotarea" type="text" class="form-control" name="lotarea" value="{{$lotDetails->lotArea}} {{$lotDetails->unitOfMeasure}}" required> -->
                            </div>
                        </div>

                        <div class="form-group row rightofway">
                            ...
                            <?php $rways = $lotDetails->rightOfWay; 
                            ...
                            <div class="col-md-7">
                                ...
                                <!-- <input id="rightofway1" type="checkbox" class="" name="rightofway[]" value="Motorcycle">Motorcycle<br>
                                <input id="rightofway2" type="checkbox" class="" name="rightofway[]" value="Car">Car<br> -->
                                <!-- <input id="rightofway3" type="checkbox" class="" name="rightofway[]" value="Bus">Bus<br> -->
                                <!-- <input id="rightofway4" type="checkbox" class="" name="rightofway[]" value="DumpTruck">Dump Truck<br>
                                <input id="rightofway5" type="checkbox" class="" name="rightofway[]" value="TenWheelerTruck">Ten Wheeler Truck -->
                            </div>
                        </div>
                        ...
                        <div id="rent" style="display:none;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="rentprice" type="text" class="form-control" name="rentprice" value="{{ old('leaseprice') }}" >
                                </div>
                            </div>
                        ...
                        <div id="lease" style="display:none;">
                            ...
                            <div class="form-group row">
                                <label for="leasecontract" class="col-md-4 col-form-label text-md-right">{{ __('Contract Period') }} </label>
                                    <div class="col-md-6">
                                        <select name="leasecontract"  class="form-control">
                                        <option value="">Select one</option>
                                        @foreach($months as $month)
                                        <option value="{{$month['month']}}">{{$month['month']}}</option>
                                        @endforeach
                    ...
                    <div id="installment" style="display:none;">                      
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="file" type="file" class="" name="file[]" accept="image/*">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="video" type="file" class="" name="file[]" accept="video/*" multiple>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="document" type="file" class="" name="document[]" accept="image/*">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="document" type="file" class="" name="document[]" accept="image/*" required>
                            </div>
                        </div>
                        ...
                        <div class="text-center" style="margin:5px 15px 0px 15px;">
                            <input type="submit" value="POST" class="btn btn-info btn-block rounded-5 py-2">
                            <br/>
...
<script>
        ...
        //         if (price >= ({{$lotDetails->lotMarketValue}}+500000)) {
        //            alert(price);
        //         } 
        //     });
        ...
        // $("input[type='submit']").click(function(){
            ...
            iprice = $("#installmentprice").val();
                ...
                if (iprice >= ({{$lotDetails->lotMarketValue}}+500000)) {
                   alert('Price is too high compared to its lot market value. Click "OK" to proceed.');
                   return true;
                } 
    });
