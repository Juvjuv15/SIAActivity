        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="card-body">
                ...
                <table  width="100%">
                            ...
                            <table width="100%" style="border-left:2px solid gray;">
                                ...
                                <tr>
                                    ...
                                    @if($lotDetails->paymentType=="Installment")
                                        ...
                                        @endif
                                        <td class="f10">{{$lotDetails->installPaymentType}} {{$lotDetails->installTimeToPay}}</td>
                                        <td class="f10">P{{number_format($lotDetails->installPayment,2)}}</td>
                                    @endif
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <a href="{{url('/document/'.$lotDetails->tid.'/view')}}">VIEW ATTACHED DOCUMENTS</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <font color="red" size="2"><b>{{ __('Date Posted') }}</b></font> <font color="" size="2">{{date('F d, Y', strtotime($lotDetails->created_at))}}</font>
                        </td>
                    </tr>
                </table>
            </div>
