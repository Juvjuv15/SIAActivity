                            ...
                            <center><p id="capslockMessage">Caps lock is ON.</p></center>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input id="contact" type="text" class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" name="contact" value="{{ old('contact') }}" placeholder="Primary Contact Number" required>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <input id="secondarycontact" type="text" class="form-control{{ $errors->has('secondarycontact') ? ' is-invalid' : '' }}" name="secondarycontact" value="{{ old('secondarycontact') }}" placeholder="Secondary Contact Number (optional)">
